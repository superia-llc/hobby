 ...
 <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  ...
  <script type="text/javascript">
	function changeValue(){
		...
		var product = ((option*250) - ((option*250)*0.4)) + 500;
  ...
  <div class="card-body center">
    ...
    <h2 class="card-title text center"><center>UNIT 8 PROMO BOOKING</center></h2>
	<center><i>*available from May 12, 2018 to May 14, 2018</i></center>
...
?> 
	<form method="POST" action="bookUnitPromo2.php">
