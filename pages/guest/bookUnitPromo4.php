 ...
 <script>
  ...
  <script type="text/javascript">
	function changeValue(){
		...
		var product = ((option*250) - ((option*250)*0.3)) + 500;
  ...
  <div class="card-body center">
    ...
    <h2 class="card-title text center"><center>UNIT 12 PROMO BOOKING</center></h2>
	<center><i>*available from May 21, 2018 to May 23, 2018</i></center>
...
?> 
	<form method="POST" action="bookUnitPromo4.php">
